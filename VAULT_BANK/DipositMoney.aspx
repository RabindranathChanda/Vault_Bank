<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DipositMoney.aspx.cs" Inherits="VAULT_BANK.DipositMoney" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Deposit Money - VAULT BANK</title>
    ...
    <form id="form1" runat="server">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="#"  onclick="refreshPage()"><i class="fas fa-donate"></i> Deposit</a></li>
                <li><a href="Transactions.aspx"><i class="fas fa-money-check-alt"></i> Transactions</a></li>
        ...
        <div class="main-content">
            ...
            <div class="content">
                <div class="card">
                    <h3>Deposit Money</h3>
                    <asp:TextBox ID="dipositAmount" runat="server" placeholder="Amount" CssClass="input-box"></asp:TextBox>
                    <asp:Button ID="dipositBtn" runat="server" Text="Deposit" CssClass="button" OnClick="DipositMoney_Click" />
                </div>
                <div class="card">
